...
layout = html.Div([
    ...
    html.Div([
        dbc.Row([
            dbc.Col(dcc.Link('Go to next plot', href='/plots_2014'))
        ], align='right')
    ]),
    ...
    The data set contains variables for a measurement of the temperatures and precipitation for each day in 2014. 
    ...
    Each page will be used to navigate through all the plots. It is possible to enter the next plot down below, but it is also possible to return to the main menu and choose a page.
